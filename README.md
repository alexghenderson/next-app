...
## TL; DR
It's a project bootstrapped with create-next-app, with some built in changes:
- Support for optional chaining/nullish coalescing
- React-SSR-Prepass with a visitor function (static Component.fetchData)
- imports from `./src` mapped to `~/`
- Logger (browser & node) with correlation ids and request contexts
- Example services
- Isomorphic redux and @reduxjs/toolkit
- Environment and platform (node/web) specific config files
- All fully typed
- Works with now.sh out of the box
